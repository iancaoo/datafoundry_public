...
Public docs cover local trials, open-source integration, and development demos. Production multi-user auth, tenant isolation, centralized secret management, monitoring, and operations need separate design. For a first trial, use the built-in DuckDB demo data source to experience the core flow.
